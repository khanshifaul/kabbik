      ...
      <BrowserRouter>
        <div className="bg-white">
          <div className="container flex justify-between items-center mx-auto my-2 px-2">
            ...
            <nav>
              <ul className="flex gap-5 justify-between items-center mx-3 font-Archivo_Narrow">
                <li>
                  <NavLink
                    to="/"
                    className={({ isActive }) =>
                ...
                <li>
                  ...
                  >
                    <button className="bg-ForestGreen font-Archivo_Narrow px-6 py-1 text-white font-medium rounded-full">
                      Login
                    </button>
                  </NavLink>
                </li>
